...
namespace BMS.Bll
{
    public class TokenEmployee
    {
        ...
        public TokenEmployee(IConfiguration configuration)
        {
        ...
        public string CreateAccessToken(DtoLoginEmployee user)
        {
            ...
            var claims = new[]
            {
                ...
                new Claim(JwtRegisteredClaimNames.Sub,user.EmployeeSurname),
                new Claim(JwtRegisteredClaimNames.Jti,user.EmployeeId.ToString())
            };
